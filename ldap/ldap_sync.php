...
<body>
    <div class="ldap-container">
        <h1><label>Sinkronkan dengan akun @SIG.corp</label></h1>
        <div class="ldap-wall">
        	<form name = "formx" class="form-signin" action = "ldap_addsync.php" onsubmit="cek()" method = "post">
        		...
        		<input class="btn btn-lg btn-block btn-primary" type = "submit" name = "Sign In" value="Sinkronkan"/> <br>
            </form>
        </div>
        <?php
