<?php
	...
	if (@ldap_bind($ldap_con, $ldap_dn, $ldap_password)){
        ...
        if ($num_row ==0) {
        	...
        	$insert = mysqli_query ($bd,"INSERT INTO users (tipe_login,username,fullname,role,employee_number,profile,phone_number,address,date_created,date_password_created,date_password_expiry,latest_ip_addr,ad_mapping) VALUES ('AD','$ldap_username','$fullname','1','0','1','$phone','unknown',NOW(),NOW(),NOW() + interval '$exp' day,'$ip','$email')");
	        ...
	        $_SESSION['IP'] = $ip;
			session_write_close();
	        header("location: ../home.php?ap=ad");
	        exit();
        ...
        session_write_close();
        header("location: ad_index.php?msg=$regmsg");
        exit();
	}
?>